...
const socket = io("https://multiapp-server.onrender.com/", {
...
export const initiateCall = (receiverId: string, callType: string, caller: string) => {
...
export const acceptCall = (callerId: string) => {
