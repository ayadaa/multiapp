...
type IncomingCallParamList = {
  IncomingCall: {
    caller: UserProfile;
    callType: string;
  };
};
type IncomingCallScreenRouteProp = RouteProp<IncomingCallParamList, 'IncomingCall'>;
...
const IncomingCallScreen = () => {
  ...
  const handleAccept = () => {
    ...
    acceptCall(caller.uid); // id -> uid //ayad
  ...
  return (
    <View style={styles.container}>
      <View style={styles.callerInfoContainer}>
        <Image source={{ uri: caller.profilePicture }} style={styles.callerImage} />
